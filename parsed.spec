...
Source0:        junit-4.12-clean.tar.gz
...
xmvn-install  -R .xmvn-reactor -n junit -d "/home/ardilla/rpmbuild/BUILDROOT/junit-4.12-5.fc25.x86_64" 
jdir=target/site/apidocs; [ -d .xmvn/apidocs ] && jdir=.xmvn/apidocs 
if [ -d "${jdir}" ]; then 
   install -dm755 /home/ardilla/rpmbuild/BUILDROOT/junit-4.12-5.fc25.x86_64/usr/share/javadoc/junit 
   cp -pr "${jdir}"/* /home/ardilla/rpmbuild/BUILDROOT/junit-4.12-5.fc25.x86_64/usr/share/javadoc/junit 
   echo '/usr/share/javadoc/junit' >>.mfiles-javadoc 
fi 
